...
const incompleteFish = z.object({
  ...
  plantSafe: z.boolean().optional(),
  invertebrateSafe: z.boolean().optional(),
  ...
  miscellaneousNotes: z.string().optional(),
  relatedNoteSlugs: z.array(z.string()).optional(),
  qrSummary: z.string().optional(),
  quickWarnings: z.array(z.string()).optional(),
  showAdditionalPhotos: z.boolean().optional(),
...
const notes = defineCollection({
  ...
  schema: z.object({
    ...
    showRelatedFish: z.boolean().optional(),
    ...
    showVisualNote: z.boolean().optional(),
